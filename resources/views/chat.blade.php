<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="example">
                        ...
                        <div class="flex input-with-button donation-form">
                            <div class="input-wrapper text-poppins">
                                ...
                                <input  type="text" style="background: transparent!Important;color: #acafb7!Important;" name="message" id="message" class="text-poppins outline-none" placeholder="Message...">
                            </div>
                            <input type="hidden" name="auction" value="{{ $auction->id }}" id="auction"><br>
                            <button  class="give-now outline-none text-poppins" id="sendMessage">Send</button>
                        </div>
                    ...
                    <section id="bidrResults">
                        ...
                        @foreach($auction->message as $message)
                            <details>
                                <summary>
                                    <div>
                                        <span>
                                        ...
                                        <h3>
                                            <strong>{{ $message->user->name }}</strong> <small>Bid</small>
                                        </h3>
                                        <span class="plus" style="{{ $message->user->id == auth()->user()->id ? 'color: green':'' }}">"{{ $message->message }}"</span>
                                    </div>
                                </summary>
                                <div>
                                    <dl>
                                        <div>
                                            <dt>Time</dt>
                                            <dd>{{ $message->created_at->diffForHumans() }}</dd>
                                        </div>
                                        <div>
                                            <dt>Card used</dt>
                                            <dd>•••• 6890</dd>
    ...
    @include('chat-js',['auction' => $auction])
